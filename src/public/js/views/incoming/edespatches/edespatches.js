...
$(document).ready(function () {
            ...
            },
            {
                ...
                render: (data, type, row) => {
                    ...
                    <div class="btn-group" role="group">
                        <button id="preview-despatch" type="button" class="btn btn-icon btn-label-info waves-effect waves-light preview-button">
    ...
    $("#despatches tbody").on("click", "#preview-despatch", function (e) {
        ...
        $.when(
            ...
            $.ajax({
                type: "GET",
                url: `/documents/despatches/detail?uuid=${data.id}&dir=in&document=edespatch`,
                success: function (response) {
            ...
            markDespatch([data.id], "in", "read", true);
        });
    });
    ...
    $("#print-despatch-in-preview").click((e) => {
        ...
        markDespatch([uuid], "in", "print", true);
        $("#print-label").empty();
    ...
    $("#despatches tbody").on("click", "#mark-unread", function (e) {
        let data = despatch_table.row($(this).parents("tr")).data();
        markDespatch([data.id], "in", "read", false);
    });
    $("#despatches tbody").on("click", "#mark-print", function (e) {
        let data = despatch_table.row($(this).parents("tr")).data();
        markDespatch([data.id], "in", "print", true);
    });
    $("#despatches tbody").on("click", "#mark-unprint", function (e) {
        let data = despatch_table.row($(this).parents("tr")).data();
        markDespatch([data.id], "in", "print", false);
    });
    ...
    $("#coll-mark-read").click((e) => {
        ...
        markDespatch(clicked.toArray(), "in", "read", true);
    });
    $("#coll-mark-unread").click((e) => {
        let clicked = despatch_table.column(0).checkboxes.selected();
        markDespatch(clicked.toArray(), "in", "read", false);
    });
    $("#coll-mark-print").click((e) => {
        let clicked = despatch_table.column(0).checkboxes.selected();
        markDespatch(clicked.toArray(), "in", "print", true);
    });
    $("#coll-mark-unprint").click((e) => {
        let clicked = despatch_table.column(0).checkboxes.selected();
        markDespatch(clicked.toArray(), "in", "print", false);
    });
    $("#coll-pdf-download").click((e) => {
        ...
        Swal.fire({
            icon: "question",
            title: "Emin misiniz?",
            text: `${clicked.length} adet irsaliyeyi toplu PDF olarak indirmek istediğinize emin misiniz?`,
                    ...
                    onAllSettled: () => {
                        Swal.fire({
                            ...
                            zip.generateAsync({
                                ...
                                saveAs(
                                    zipBlob,
                                    "Toplu PDF Gelen e-İrsaliyeler.zip",
                                    "application/zip"
                                );
                            });
                        });
    ...
    $("#coll-xml-download").click((e) => {
        ...
        Swal.fire({
            icon: "question",
            title: "Emin misiniz?",
            text: `${clicked.length} adet irsaliyeyi toplu XML olarak indirmek istediğinize emin misiniz?`,
            showConfirmButton: true,
            confirmButtonText: "Evet, indir",
            showCancelButton: true,
            cancelButtonText: "Hayır, indirme",
                    ...
                    onAllSettled: () => {
                        Swal.fire({
                            ...
                            zip.generateAsync({
                                ...
                                saveAs(
                                    zipBlob,
                                    "Toplu XML Gelen e-İrsaliyeler.zip",
                                    "application/zip"
                                );
                            });
                        });
    ...
    $("#coll-pdf-one-page-download").click((e) => {
        ...
        Swal.fire({
            icon: "question",
            title: "Emin misiniz?",
            text: `${clicked.length} adet irsaliyeyi tek sayfa PDF olarak indirmek istediğinize emin misiniz?`,
            showConfirmButton: true,
            confirmButtonText: "Evet, indir",
            showCancelButton: true,
            cancelButtonText: "Hayır, indirme",
                ...
                ajaxThrottle({
                    ...
                    onAllSettled: () => {
                        Swal.fire({
                            ...
                            const fileName1 = `Tek Sayfa PDF Gelen e-İrsaliye.pdf`;
    ...
    $("#coll-despatch-xlsx-download").click((e) => {
        ...
        Swal.fire({
            icon: "question",
            title: "Emin misiniz?",
            text: `${clicked.length} adet irsaliyeyi Excel olarak indirmek istediğinize emin misiniz?`,
            showConfirmButton: true,
            confirmButtonText: "Evet, indir",
            showCancelButton: true,
            cancelButtonText: "Hayır, indirme",
            ...
            if (result.isConfirmed) {
                ...
                clicked.each((id) => {
                    requests.push({
                        type: "GET",
                        url: `/documents/despatches/detail?uuid=${id}&dir=in&document=edespatch`,
                        success: async (result) => {
                            excelData.push(
                ...
                ajaxThrottle({
                    ...
                    onAllSettled: () => {
                        Swal.fire({
                            ...
                            saveAs(
                                fileData,
                                "Gelen e-İrsaliyeler" + fileExtension
                            );
                        });
                    },
                    onAnyFailed: () => {},
