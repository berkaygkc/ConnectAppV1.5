...
$(document).ready(function () {
            ...
            },
            {
                ...
                render: (data, type, row) => {
                    ...
                    <div class="btn-group" role="group">
                        <button id="preview-invoice" type="button" class="btn btn-icon btn-label-info preview-button">
    ...
    $("#invoices tbody").on("click", "#preview-invoice", function (e) {
        ...
        $.when(
            ...
            $.ajax({
                type: "GET",
                url: `/documents/invoices/detail?uuid=${data.id}&dir=out&document=einvoice`,
                success: function (response) {
    ...
    $("#invoices tbody").on("click", "#send-mail", function (e) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/documents/invoices/mail?document=einvoice",
                    headers: {
                    ...
                    onAllSettled: () => {
                        Swal.fire({
                            ...
                            zip.generateAsync({
                                ...
                                saveAs(
                                    zipBlob,
                                    "Toplu PDF Giden e-Faturalar.zip",
                                    "application/zip"
                                );
                            });
                        });
                    ...
                    onAllSettled: () => {
                        Swal.fire({
                            ...
                            zip.generateAsync({
                                ...
                                saveAs(
                                    zipBlob,
                                    "Toplu XML Giden e-Faturalar.zip",
                                    "application/zip"
                                );
                            });
                        });
                ...
                ajaxThrottle({
                    ...
                    onAllSettled: () => {
                        Swal.fire({
                            ...
                            const fileName1 = `Tek Sayfa PDF Giden e-Fatura.pdf`;
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                clicked.each((id) => {
                    requests.push({
                        type: "GET",
                        url: `/documents/invoices/detail?uuid=${id}&dir=out&document=einvoice`,
                        success: async (result) => {
                            excelData.push(
                ...
                ajaxThrottle({
                    ...
                    onAllSettled: () => {
                        Swal.fire({
                            ...
                            saveAs(
                                fileData,
                                "Giden e-Faturalar" + fileExtension
                            );
                        });
                    },
                    onAnyFailed: () => {},
